...
%Increase space for phone #, fix cancel button
%Add something to check if the phone number has enough digits, and will
%only accept digits.
...
while order==1
%Currently not looping when you order an item
    ...
    order = 0;
    %This is why it's not looping.  Move to an if(done)
end

AGAIN = menu ('Is this correct?','Yes','No');
%Closing out of the window brings you here.  Maybe move this in the while loop
%Order does not display when here
switch AGAIN
%Reciept does not display
        case 1
